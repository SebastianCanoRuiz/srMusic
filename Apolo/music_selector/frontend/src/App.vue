        ...
        <div clas="mt-4">
          <div class="inner cover">
            ...
            <p class="lead cover-copy">
              El Prototipo del Sistema de Recomendación Musical
              <strong>APOLO</strong> te recomienda música basada en tus emociones. 
            <strong>APOLO</strong> se preocupa por cómo te sientes.</p>
            <br />
            <p
              class="lead cover-copy"
            >Más de 1000 videos musicales libres de derechos de autor de YouTube.</p>
            <p>
              <br />
            </p>
            <p class="lead cover-copy">Disfrútalo :3</p>
            <br />
            <p class="lead">
              <a href="#contenido">
          ...
          <div>
            <div class="mastfoot">
              <div class="inner">
                <p>
                  &copy; Prototipo SR-Musical Apolo. Diseñado por:
                  <br />
                  <a href="" target="_blank">Jhon Sebastian Cano Ruiz & Johan Steeven Sanchez Sepúlveda</a>.
                  <br />2020
                </p>
              </div>
            </div>
